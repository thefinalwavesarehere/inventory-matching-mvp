...
const FORMAT_SCHEMAS = {
  ...
  review: {
    title: 'Manual Review CSV Format',
    description: 'Expected format for re-importing reviewed matches',
    columns: [
      { name: 'status', description: 'Match status', example: 'pending' },
      { name: 'method', description: 'Matching method used', example: 'fuzzy' },
      { name: 'confidence', description: 'Confidence score', example: '0.85' },
      { name: 'store_part_number', description: 'Store part number', example: '01-ABC123' },
      { name: 'store_line_code', description: 'Store line code', example: '01' },
      { name: 'store_description', description: 'Store part description', example: 'BRAKE PAD SET' },
      { name: 'supplier_part_number', description: 'Supplier part number', example: '01-XYZ789' },
      { name: 'supplier_line_code', description: 'Supplier line code', example: '01' },
      { name: 'supplier_description', description: 'Supplier part description', example: 'BRAKE PAD KIT' },
      { name: 'review_decision', description: 'Your decision: approve, reject, or leave blank', example: 'approve' },
      { name: 'corrected_supplier_part_number', description: 'Corrected part number (if review_decision is blank)', example: '01-CORRECT123' },
    ],
    notes: [
      'review_decision values: "approve", "reject", or leave blank for correction',
      'If review_decision is blank, provide corrected_supplier_part_number',
      'Case-insensitive for review_decision',
      'All other columns should match the exported format',
    ],
  },
};
