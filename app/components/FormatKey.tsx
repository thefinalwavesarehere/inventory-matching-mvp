...
const FORMAT_SCHEMAS = {
  ...
  review: {
    ...
    columns: [
      ...
      { name: 'vendor_action', description: '✏️ OPTIONAL: Set vendor action - "LIFT", "REBOX", "CONTACT_VENDOR", "UNKNOWN", or "NONE"', example: 'REBOX' },
    ],
    notes: [
      ...
      '📦 To SET VENDOR ACTION: Set vendor_action to "LIFT", "REBOX", "CONTACT_VENDOR", "UNKNOWN", or "NONE" (optional)',
      '📥 Workflow: Click "Export Pending" → Open CSV in Excel → Edit review_decision column → Save → Click "Import CSV"',
      '⚠️ Do NOT edit any columns except review_decision, corrected_supplier_part_number, and vendor_action',
