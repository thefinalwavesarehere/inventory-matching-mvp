  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="glass-panel p-6 mb-6 border border-gray-200/50">
        ...
        {/* Search Bar */}
        <div className="glass-panel p-4 mb-6 border border-gray-200/50">
        ...
        {/* Rules List */}
        <div className="glass-panel border border-gray-200/50">
          {loading ? (
